...
class SLICProcessor(object):
    ...
    def __init__(self, filename, K, M):
        ...
        if self.data.shape[0] > self.data.shape[1]:
            ...
            self.data = resize(self.data, (self.image_height, 400), anti_aliasing=True)[int((self.image_height-400)/2):int(self.image_height-(self.image_height-400)/2),0:400]
            self.image_height = 400
        else:
            self.image_height = 400
            self.image_width = self.data.shape[1]*400//self.data.shape[0]
            self.data = resize(self.data, (400, self.image_width), anti_aliasing=True)[0:400,int((self.image_width-400)/2):int(self.image_width-(self.image_width-400)/2)]
            self.image_width = 400
    ...
    def run_filter(self):
        ...
        self.assignment()
        self.update_cluster()
        self.save_current_image(self.filename.replace(self.filename.split(".")[-1],"png"))